...
export const GET_USER_PROFILE = "/users/get";
export const ADD_NEW_USER = "/users/post";
export const UPDATE_USER = "/users/put";
...
//--------------------------------
export const ADD_JOB_ROLE = "/";
export const EDIT_JOB_ROLE = "/";

export const GET_LOCATION = "/location_master/get";
export const ADD_LOCATION = "/location_master/post";
export const UPDATE_LOCATION = "/location_master/put";