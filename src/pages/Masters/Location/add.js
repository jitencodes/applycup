...
import {ADD_LOCATION} from "../../../helpers/url_helper"
...
class LocationAdd extends React.Component {
  ...
  handleFormSubmit = (e) => {
    ...
    if (this.validator.allValid()) {
      ...
      post(ADD_LOCATION,formData).then(response => {
        if (response.status) {
      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid={true}>
            <Breadcrumbs title="Manage Location" path="/location" breadcrumbItem="Add Location"/>
            <Row>
              <Col xl="12">
                <Card>
                  <CardBody>
