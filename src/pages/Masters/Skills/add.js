...
import {ADD_SKILL} from "../../../helpers/api_url_helper"
import toastr from "toastr"
import PropTypes from "prop-types"

class SkillsAdd extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      skill: "",
    ...
    if (this.validator.allValid()) {
      ...
      post(ADD_SKILL,formData).then(response => {
        if (response.status) {
          ...
          toastr.success('Skill added successful.')
      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid={true}>
            <Breadcrumbs title="Manage Skills" path="/skills" breadcrumbItem="Add Skill"/>
            <Row>
              <Col xl="12">
                <Card>
                  <CardBody>
                    <form onSubmit={this.handleFormSubmit}>
                      <Row>
                        <Col md="4" className="mb-3">
                          ...
                          <input name="skill" placeholder="Type Skill Name" defaultValue={this.state.skill} type="text" className={"form-control"} onChange={this.handleInput}/>
