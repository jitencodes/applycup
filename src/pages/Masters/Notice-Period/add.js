...
import {ADD_NOTICE_PERIOD} from "../../../helpers/api_url_helper";
import toastr from "toastr"
import PropTypes from "prop-types"


class NoticePeriodAdd extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      notice_period: "",
  ...
  handleFormSubmit = (e) => {
    ...
    if (this.validator.allValid()) {
      ...
      post(ADD_NOTICE_PERIOD,formData).then(response => {
        if (response.status) {
      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid={true}>
            <Breadcrumbs title="Notice Period" path="/notice-period" breadcrumbItem="Add"/>
            <Row>
              <Col xl="12">
                <Card>
                  <CardBody>
...
export default NoticePeriodAdd
