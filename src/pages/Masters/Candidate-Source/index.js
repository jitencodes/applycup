...
import {EXPORT_MASTER, GET_CANDIDATE_SOURCE} from "../../../helpers/api_url_helper";
...
const CandidateSource = () => {
  ...
  useEffect(() => {
    ...
    get(GET_CANDIDATE_SOURCE, {params: params}).then(res => {
      hideLoader()
      if (res) {
  ...
  const ImportCSV = (e) => {
    ...
    if (file !== undefined) {
      ...
      formData.append('master_name', 'Candidate-Source')
    ...
    <React.Fragment>
      <div className="page-content">
        ...
        <div className="container-fluid">
          <Breadcrumbs title="Dashboard" path="/" breadcrumbItem="Manage Candidate Source" />
          <Row>
                    ...
                    <table className="table table-striped">
                      ...
                      {!loader && tableData.map((value,index) => (
                        <tr key={++index}>
                          ...
                          <td><Link to={`/candidate-source/edit/${value.id}`}><i className="bx bxs-edit-alt"></i> </Link></td>
                        </tr>
                      ))}
                      </tbody>
                    </table>
