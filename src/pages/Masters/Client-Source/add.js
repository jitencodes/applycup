...
import {ADD_CLIENT_SOURCE} from "../../../helpers/api_url_helper"
import toastr from "toastr"
import PropTypes from "prop-types"

class ClientSourceAdd extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      source: "",
  ...
  handleFormSubmit = (e) => {
    ...
    if (this.validator.allValid()) {
      ...
      post(ADD_CLIENT_SOURCE,formData).then(response => {
        if (response.status) {
      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid={true}>
            <Breadcrumbs title="Client Source" path="/client-source" breadcrumbItem="Add"/>
            <Row>
              <Col xl="12">
                <Card>
                  <CardBody>
...
ClientSourceAdd.propTypes = {
  location: PropTypes.object
}

export default ClientSourceAdd
