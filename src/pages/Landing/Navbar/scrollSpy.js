...
class ScrollspyNav extends Component {
  ...
  scrollSection = () => {
    ...
    this.scrollTargetIds.forEach((sectionID, index) => {
     if (document.getElementById(sectionID) !== undefined && document.getElementById(sectionID).offsetTop !== null && document.getElementById(sectionID).offsetTop !== undefined) {
  ...
  clearOtherNavLinkActiveStyle(excludeSectionID) {
    this.scrollTargetIds.forEach((sectionID) => {
      if (sectionID !== excludeSectionID && this.getNavLinkElement(sectionID).classList !== undefined) {
        this.getNavLinkElement(sectionID).classList.remove(this.activeNavClass)
        this.getNavLinkElement(sectionID).parentNode.classList.remove(
          this.activeNavClass
        )
